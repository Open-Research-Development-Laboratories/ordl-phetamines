...
## Decision
Implement ORDL platform as a clean-room system that does not import or copy upstream OpenClaw source code.
...
4. No code-level dependency on upstream OpenClaw internals.
